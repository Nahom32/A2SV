...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: stones = [2,7,4,1,8,1]
Output: 1
Explanation: 
...
" data-snippet-id="ext.dc3d96c4ebd974ecbb9f9c0ddbdf5928" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> stones = [2,7,4,1,8,1]
