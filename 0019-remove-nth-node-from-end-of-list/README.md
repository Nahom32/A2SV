...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: head = [1,2,3,4,5], n = 2
Output: [1,2,3,5]
" data-snippet-id="ext.3d26eaedeee9b5b993b6d457c45dec74" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> head = [1,2,3,4,5], n = 2
