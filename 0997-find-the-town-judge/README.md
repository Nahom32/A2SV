...
<div class="top-box hide"><div class="alert-info"></div></div><pre data-original-code="Input: n = 3, trust = [[1,3],[2,3],[3,1]]
Output: -1
" data-snippet-id="ext.7978c03c362b9ca0a02f76b39c068a59" data-snippet-saved="false" data-codota-status="done"><strong>Input:</strong> n = 3, trust = [[1,3],[2,3],[3,1]]
